 <template>
     <div class="dialog">
        ...
        <div class="form">
            ...
            <el-form-item  prop="descript" label="收支描述:">
                <el-input type="descript" v-model="formData.descript"></el-input>
            </el-form-item>
             ...
             <el-form-item class="btn_send">
               <el-button type="primary" @click="onSubmit('form')">提交</el-button>
               <el-button type="default" @click="dialog.show = false">取消</el-button>   
            </el-form-item>
            </el-form>
        </div>
         </el-dialog>
        ...
        return{
            ...
            form_rules:{
                descript:[
                 ...
                 cash:[
                    {required:true,message:'账户现金输入不能为空!' , trigger:'blur'}
                ]
            }
        }
    }
